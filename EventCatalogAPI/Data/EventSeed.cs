    ...
    public class EventSeed
    {
        ...
        private static IEnumerable<EventItem> GetPreConfiguredEventItems()
        {
            ...
            { 
                ...
                new EventItem() { EventTypeId = 6,EventTopicId = 2, Description = "Interaction Week 2019 will assemble a diverse group of practitioners and academics from around the world to explore the edges of interaction design, and help spark a transformation of the discipline to be relevant to the needs of the 21st century. ", Title = "Interaction Week 2019", Location = "Seattle,Seattle, WA 98121",StartDate=" Feb 3, 2019",EndDate="Feb 8, 2019",Price = 95.0M, ImageUrl = "http://externaleventbaseurltobereplaced/api/pic/2" },
